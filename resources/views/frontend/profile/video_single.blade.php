@foreach($all_videos as $video)
    <div class="single-item-countable single-photo n_video">
        ...
        <a href="javascript:void(0)" onclick="confirmAction('{{ route('delete.mediafile', $video->id) }}', true)" class="del_v_icon"><i class="fa-solid fa-trash"></i></a>
        {{-- <div class="post-controls dropdown dotted">
            ...
            <ul class="dropdown-menu"
                ...
                <li><a class="dropdown-item" href="javascript:void(0)" onclick="confirmAction('{{ route('delete.mediafile', $video->id) }}', true)">{{ get_phrase('Delete Video') }}</a></li>
            </ul>
        </div> --}}
    </div>
@endforeach
