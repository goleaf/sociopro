<aside class="sidebar">
    ...
    <div class="widget" id="my-profile-info">
        ...
        <div class="my-about mb-8  mt-8">
            {!! script_checker($user_info->about) !!}
        </div>
    ...
    <div class="widget friend-widget">
        <div class="n_pro_con d-flex align-items-start">
            <div class="widget-header">
                ...
                <span class='f-text'>{{ $viewData->profileFriends($user_info)['count'] }} {{ get_phrase('Friends') }}</span>
            </div>
        ...
        <div class="f_image_g row-cols-3 g-1 mt-8">
            @foreach ($viewData->profileFriends($user_info)['items'] as $friends_user_data)
