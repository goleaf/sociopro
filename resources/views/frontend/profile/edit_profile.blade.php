...
<form class="ajaxForm" action="{{ route('profile.update_profile') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input value="{{ $user_info->name }}" id="name" name="name" type="text" class="form-control"
                placeholder="{{ get_phrase('Enter your name') }}" aria-label="Name" required>
        </div>
        <div class="col">
            <label for="nickname">{{ get_phrase('Nickname') }}</label>
            <input value="{{ $user_info->nickname }}" id="nickname" name="nickname" type="text" class="form-control"
    ...
    <div class="mb-3">
        ...
        <input value="{{ $user_info->marital_status }}" id="marital_status" name="marital_status" type="text"
    ...
    <div class="mb-3">
        ...
        <input value="{{ $user_info->phone }}" id="phone" name="phone" type="text" class="form-control"
    ...
    <div class="mb-3">
        ...
        <input value="{{ date('Y-m-d', $user_info->date_of_birth) }}" id="date_of_birth" name="date_of_birth"
