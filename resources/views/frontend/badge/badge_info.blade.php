                           ...
                           <div class="batch E_new_batch">
                            ...
                            <p>{{get_phrase('You are subscribing to Meta Verified on Sociopro.')}}</p>
                               <div class="demo-badge E_badge">
                                   ...
                                   <h4>{{get_phrase("You'll be billed")}} {{currency($badgePrice)}} {{get_phrase('per month.')}}</h4>

                               </div>
                               <h3>{{get_phrase('What you get with your subscription.')}}</h3>
                               <form action="{{route('badge.payment_configuration',['id' => $badgeUser->id])}}" method="POST" enctype="multipart/form-data">
                                @csrf
