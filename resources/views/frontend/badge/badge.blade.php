    ...
    <div class="g-3 blog-cards" >
        <div class="row" id="batchdatashow">
            <div class="col-12  h-100 my-1 single-item-countable" id="batch">
                        ...
                        <div class="batch">
                            <div class="demo-badge">
                                ...
                                <div class="badge-image">
                                    <img src="{{ get_user_image($badgeUser->photo, 'optimized') }}" alt="">
                                    <div class="badge_info d-flex justify-content-center mt-2">
                                        <h5>{{ $badgeUser->name }}</h5>
                ...
                @if($badgeHistoryRows->isNotEmpty())
                    ...
                    <div class="entry-txt p-8">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                  ...
                                  @foreach($badgeHistoryRows as $badgeHistoryRow)
                                        <tr class="single-row table-light">
                                            <th scope="row">
                                                <div class="single-cell">
                                                    <div class="cell-item">
                                                        <p>{{ $badgeHistoryRow['number'] }}</p>
                                                    </div>
                                                </div>
                                            </th>
                                            <td>
                                            ...
                                            <td>
                                                <div class="single-cell">
                                                    <a href="javascript:;"  class="cell-item item">
                                                       <p>{{ $badgeHistoryRow['start_date'] }}</p>
                                                    </a>
                                                </div>
                                            </td>
                                            <td>
