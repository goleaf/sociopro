                            ...
                            <div class="pt-publisher @if(isset($_GET['shared'])) hidden-on-shared-view @else d-flex @endif align-items-center justify-content-between">
                                ...
                                <div class="pb-share e_market d-flex justify-content-between">
                                    ...
                                    <span>
                                        ...
                                        @else
                                        <a href="javascript:void(0)" class="common_btn" onclick="ajaxAction('{{ route('save.product.later',$product->id) }}')"> 
            ...
            <div class="row">
                <div class="n_detals_p pt-details @if(isset($_GET['shared'])) hidden-on-shared-view @endif">
                    ...
                    <div class="product-description p_des mt-20">
                        {!! script_checker($product->description, false) !!}
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="product-info np_info_pro">
                ...
                <div class="pt-publisher @if(isset($_GET['shared'])) hidden-on-shared-view @else d-flex @endif align-items-center justify-content-between">
                    ...
                    <div class="pb-share e_market d-flex justify-content-between">
                        ...
                        <span>
                            @if ($viewData->isProductSaved($product, auth()->user()))
                            <a href="javascript:void(0)" class="common_btn_2" onclick="ajaxAction('{{ route('unsave.product.later',$product->id) }}')"> <i class="fa-solid fa-link-slash"></i> </a>
                            @else
                            <a href="javascript:void(0)" class="common_btn" onclick="ajaxAction('{{ route('save.product.later',$product->id) }}')"> <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
