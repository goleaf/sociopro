        ...
        <div class="header-menu">
          <ul>
            <li class="user-profile pe-2">
              <select class="form-control text-capitalize text-13px py-1 me-2" data-language-switch-url="{{ route('language.switch', ['language' => '__language__']) }}" onchange="window.location.href = this.dataset.languageSwitchUrl.replace('__language__', encodeURIComponent(this.value));" style="margin-top: 7px;">
