            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                    <div class="d-flex flex-column">
                        <h4>{{ get_phrase('Create Job Category') }}</h4>
                    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="eSection-wrap-2">
                <form method="POST" action="{{ route('admin.save.job.category') }}">
                    @csrf
                    <div class="mb-3">
                        <label for="jobcategory" class="form-label eForm-label">{{ get_phrase('Job Category') }}</label>
                        <input type="text" class="form-control eForm-control" id="jobcategory" name="jobcategory" value="{{ old('jobcategory') }}">
                    </div>
                    @if ($errors->any())
