...
class FilterMarketplaceRequest extends ApiFormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'min' => ['nullable', 'numeric', 'decimal:0,2', 'min:0', 'max:9999999999.99'],
            'max' => ['nullable', 'numeric', 'decimal:0,2', 'min:0', 'max:9999999999.99', 'gte:min'],
            ...
            'filters.price.min' => ['nullable', 'numeric', 'decimal:0,2', 'min:0', 'max:9999999999.99'],
            'filters.price.max' => ['nullable', 'numeric', 'decimal:0,2', 'min:0', 'max:9999999999.99', 'gte:filters.price.min'],
